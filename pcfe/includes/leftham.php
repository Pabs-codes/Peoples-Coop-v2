                  ...
                  <li>
                    ...
                    <ul style="display: block">
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >Peoples Coop T - Shirt <span title="Available Stock">- 125</span></a
                          >
                        </div>
                      </li>
                      <!-- <li>
                      ...
                      <!-- <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >jacket<span title="Available Stock">- 500</span></a
                          >
                        </div>
                      </li> -->
                      <!-- <li>
              ...
              <!-- <div class="ec-sb-block-content">
                <ul>
                  <li>
                    <div class="ec-sidebar-block-item">
                      <img
                        src="assets/images/icons/shoes-8.svg"
                        class="svg_img"
                        alt="drink"
                      />Footwear
                    </div>
                    <ul>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >Sports <span title="Available Stock">- 25</span></a
                          >
                        </div>
                      </li>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >Formal <span title="Available Stock">- 52</span></a
                          >
                        </div>
                      </li>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >Casual <span title="Available Stock">- 40</span></a
                          >
                        </div>
                      </li>
                      <li>
              ...
              <!-- <div class="ec-sb-block-content">
                <ul>
                  <li>
                    <div class="ec-sidebar-block-item">
                      <img
                        src="assets/images/icons/jewelry-8.svg"
                        class="svg_img"
                        alt="drink"
                      />jewelry
                    </div>
              ...
              <div class="ec-sb-block-content">
                <ul>
                  <li>
                    <div class="ec-sidebar-block-item">
                      <img
                        src="assets/images/icons/perfume-8.svg"
                        class="svg_img"
                        alt="drink"
                      />perfume
                    </div>
                    <ul>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >perfume brand 1<span title="Available Stock"
                              >- 4 pcs</span
                            ></a
                          >
                        </div>
                      ...
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >perfume brand 4<span title="Available Stock"
                              >- 35 pack</span
                            ></a
                          >
                        </div>
              ...
              <div class="ec-sb-block-content">
                <ul>
                  <li>
                    <div class="ec-sidebar-block-item">
                      <img
                        src="assets/images/icons/books.svg"
                        class="svg_img"
                        alt="drink"
                      />Books
                    </div>
                    <ul style="display: block">
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            > > Kelalikarayo - කැළලිකාරයෝ<span title="Available Stock"></span
                          ></a>
                        </div>
                      </li>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >> May Mara Prasangaya - මැයිමාර ප්‍රසංගය<span title="Available Stock"></span
                          ></a>
                        </div>
                      </li>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >>  Silver Tips - සිල්වර් ටිප්ස්<span title="Available Stock"></span
                          ></a>
                        </div>
                      </li>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            > > Thiwanka kathawa - තිවංක කතාව<span title="Available Stock"></span
                          ></a>
                        </div>
                      </li>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            > > Muses Books - දිස්පර‍යු<span title="Available Stock"></span
                          ></a>
                        </div>
                      </li>
                    </ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >null <span title="Available Stock">- 52</span></a
                          >
                        </div>
                      </li>
                    </ul>
              ...
              <div class="ec-sb-block-content">
                <ul>
                  <li>
                    <div class="ec-sidebar-block-item">
                      <img
                        src="assets/images/icons/bag-8.svg"
                        class="svg_img"
                        alt="drink"
                      />Others
                    </div>
                    <ul>
                      ...
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >null <span title="Available Stock">- 40</span></a
                          >
                        </div>
                      </li>
                      <li>
                        <div class="ec-sidebar-sub-item">
                          <a href="shop-left-sidebar-col-3.html"
                            >null <span title="Available Stock">- 35</span></a
                          >
                        </div>
                      </li>
                    </ul>
  ...
  <div class="ec-sb-pro-sl">
    ...
    <div>
      <div class="ec-sb-pro-sl-item">
        ...
        <div class="ec-pro-content">
          <h5 class="ec-pro-title">
            <a href="product-left-sidebar.html">May Mara Prasangaya - මැයිමාර ප්‍රසංගය</a>
          </h5>
          <div class="ec-pro-rating">
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
    ...
    <div>
      <div class="ec-sb-pro-sl-item">
        ...
        <div class="ec-pro-content">
          <h5 class="ec-pro-title">
            <a href="product-left-sidebar.html">Silver Tips - සිල්වර් ටිප්ස්</a>
          </h5>
          <div class="ec-pro-rating">
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
          ...
          <span class="ec-price">
            <span class="old-price">Rs. 650.00</span>
    ...
    <div>
      <div class="ec-sb-pro-sl-item">
        ...
        <div class="ec-pro-content">
          <h5 class="ec-pro-title">
            <a href="product-left-sidebar.html">Thiwanka Kathawa - තිවංක කතාව</a>
          </h5>
          <div class="ec-pro-rating">
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
    ...
    <div>
      <div class="ec-sb-pro-sl-item">
        ...
        <div class="ec-pro-content">
          <h5 class="ec-pro-title">
            <a href="product-left-sidebar.html">Muses Books - දිස්පර‍යු</a>
          </h5>
          <div class="ec-pro-rating">
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
          ...
          <span class="ec-price">
            ...
            <span class="new-price">Rs. 850.00</span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div>
      <div class="ec-sb-pro-sl-item">
        ...
        <div class="ec-pro-content">
          <h5 class="ec-pro-title">
            <a href="product-left-sidebar.html">New Peoples Coop T-shirt</a>
          </h5>
          <div class="ec-pro-rating">
            <i class="ecicon eci-star fill"></i>
            <i class="ecicon eci-star fill"></i>
          ...
          <span class="ec-price">
            <span class="old-price">Rs. 1500.00</span>
            <span class="new-price">Rs. 1200.00</span>
          </span>
        </div>
      </div>
    </div>
    ...
    <div>
      <div class="ec-sb-pro-sl-item">
        <div class="ec-pro-content">
          ...
          <span class="ec-price">
            <span class="old-price">N/A</span>
            <span class="new-price">N/A</span>
          </span>
        </div>
      </div>
    </div>
