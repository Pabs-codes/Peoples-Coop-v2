                  ...
                  <div class="ec-footer-links">
                    <ul class="align-items-center">
                      <li class="ec-footer-link">
                        No:null , Null Road , null , Sri Lanka
                      </li>
                      <li class="ec-footer-link">
                        <span>Call Us:</span
                        ><a href="tel:+440123456789">+94 70 535 9030</a>
                      </li>
                      <li class="ec-footer-link">
                        <span>Email:</span
                        ><a href="mailto:example@ec-email.com"
                          >Info@peoplescoop.lk</a
                        >
                      </li>
                    </ul>
                  </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="footer-bottom-social">
                  ...
                  <ul class="mb-0">
                    <li class="list-inline-item">
                      <a class="hdr-facebook" href="https://www.facebook.com/share/g/TbvrrVmEY49ry8tu/?mibextid=CTbP7E"
                        ><i class="ecicon eci-facebook"></i
                      ></a>
                    </li>
                    <li class="list-inline-item">
                      <a class="hdr-whatsapp" href="https://wa.me/94705359030"
              ...
              <div class="col text-center footer-copy">
                <div class="footer-bottom-copy">
                  <div class="ec-copy" style="font-size: 12px;">
                    Copyright © 2024
                    <a class="site-name text-upper" href="#" style="font-size: 12px;">Peoples - Coop <span>.</span></a
                    >. All Rights Reserved  <br/>
                    <span class="site-name text-upper" style="font-size: 8px;"></span><i>> Powered by Crystal Digits IT Solutions < </i></span>
                  </div>
                </div>
              </div>
